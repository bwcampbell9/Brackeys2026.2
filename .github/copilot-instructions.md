...
- Use GDScript for all game and project code. The required Godot 4 Web target cannot export C#/.NET projects, so do not add `.cs`, `.csproj`, `.sln`, or `[dotnet]` project configuration.
